...
import PaymentPageAfter from "./paymentPageafter.js";
...
import PaymentPageCounter from "./paymentPageCounter.js";
...
const AppRouter = () => (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/PaymentPageCounter" element={<PaymentPageCounter/>} />
        <Route path="/PaymentPageAfter" element={<PaymentPageAfter/>} />
