...
const TicketTypeNormal = () => {
    const calculateTotal = () => {
        ...
        const fullPrice = cookies.get('full_price');
        const discountPrice = cookies.get('concession_price');
    ...
    const fullPriceshow = cookies.get('full_price');
    const discountPriceshow = cookies.get('concession_price');
    useEffect(() => {
            ...
            <div className="tickettypenormal">
                ...
                <table className="ticketnormal">
                    ...
                    <tbody>
                        <tr>
                            <td>全票</td>
                            <td id="fullPrice">{fullPriceshow}</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td id="discountPrice">{discountPriceshow}</td>
                            <td>
