    ...
    <>
        ...
        <div>
            ...
            <div className="buttonContainer">
                <button className="paymentButton" onClick={() => console.log('臨櫃付款')}>線上即時付款<h3>一般 / 銀行優惠 / 儲值金會員票
                </h3><h3>GENERAL / BANK PRIVILEGE TICKET / iShow SVC DISCOUNT TICKET</h3></button>
            </div>
            <div className="buttonContainer">
                <button className="paymentButton" onClick={() => console.log('信用卡付款')}>影城臨櫃付款<h3>團體優待票券 / 愛心票 / 敬老票 / 免費兌換券
                </h3><h3>CORPORATE MOVIE MONEY / DISABILITY TICKET / ELDERLY TICKET / READMISSION</h3></button>
            </div>
            <div>
                <h2>注意事項</h2>
